insert into public.asset_assets (asset_code, name, software_name, type, category, status, unit_price, acquired_at, quantity)
values
  ('H-001', '맥북 프로', null, 'hardware', '노트북', '사용중', 3200000, '2024-02-15', 12),
  ('H-002', '델 서버', null, 'hardware', '서버', '사용가능', 8700000, '2023-08-10', 4),
  ('H-003', '레노버 씽크패드', null, 'hardware', '노트북', '사용가능', 2100000, '2025-01-20', 9),
  ('H-004', '시스코 스위치', null, 'hardware', '네트워크', '사용중', 1550000, '2022-11-03', 6),
  ('H-005', '파이어월 장비', null, 'hardware', '보안장비', '사용중', 4900000, '2024-06-01', 3),
  ('H-006', 'QNAP 스토리지', null, 'hardware', '스토리지', '사용가능', 3800000, null, 5),
  ('H-007', 'HP 워크스테이션', null, 'hardware', '노트북', '사용중', 2700000, '2023-12-18', 7),
  ('H-008', 'AP 컨트롤러', null, 'hardware', '네트워크', '사용가능', 980000, '2025-03-07', 11),
  ('H-009', '백업 서버', null, 'hardware', '서버', '사용가능', 6400000, '2022-04-26', 2),
  ('H-010', '보안 게이트웨이', null, 'hardware', '보안장비', '사용중', 5200000, '2024-09-12', 4),
  ('S-001', '', '윈도우 라이선스', 'software', 'OS', '활성', 320000, null, 150),
  ('S-002', '', 'Burp Suite Pro', 'software', '보안', '할당됨', 680000, null, 20),
  ('S-003', '', 'Ubuntu Server', 'software', 'OS', '활성', 0, null, 100),
  ('S-004', '', 'PostgreSQL', 'software', '데이터베이스', '활성', 540000, null, 35),
  ('S-005', '', 'Oracle DB', 'software', '데이터베이스', '할당됨', 2200000, null, 10),
  ('S-006', '', 'IntelliJ IDEA', 'software', '개발툴', '활성', 210000, null, 40),
  ('S-007', '', 'Visual Studio', 'software', '개발툴', '활성', 180000, null, 55),
  ('S-008', '', 'Nginx Plus', 'software', '미들웨어', '할당됨', 460000, null, 18),
  ('S-009', '', 'Vault Enterprise', 'software', '보안', '활성', 890000, null, 14),
  ('S-010', '', 'Redis Enterprise', 'software', '미들웨어', '활성', 730000, null, 16)
